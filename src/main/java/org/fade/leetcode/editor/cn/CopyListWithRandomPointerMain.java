...
输出：[[3,null],[3,0],[3,null]]
 ...
 Related Topics 哈希表 链表 👍 1077 👎 0

*/
  
package org.fade.leetcode.editor.cn;

import org.fade.leetcode.editor.cn.list.random.Node;

import java.util.HashMap;
import java.util.Map;

public class CopyListWithRandomPointerMain {
      
    public static void main(String[] args) {
        Solution solution = new CopyListWithRandomPointerMain().new Solution();
    }
