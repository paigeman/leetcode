...
解释：-1 与 0 之和等于目标数 -1 。因此 index1 = 1, index2 = 2 。返回 [1, 2] 。
 ...
 Related Topics 数组 双指针 二分查找 👍 1002 👎 0
...
public class TwoSumIiInputArrayIsSortedMain {
    ...
    public static void main(String[] args) {
        Solution solution = new TwoSumIiInputArrayIsSortedMain().new Solution();
        solution.twoSum(Utils.parseToArrayFromString("[2,7,11,15]"), 9);
    }
    ...
    class Solution {
        ...
        public int[] twoSum(int[] numbers, int target) {
            ...
            while (left < right) {
                while (left < right && target - numbers[left] - numbers[right] < 0) {
                    --right;
                }
