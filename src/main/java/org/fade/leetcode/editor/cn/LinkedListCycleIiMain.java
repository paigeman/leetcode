...
解释：链表中没有环。
 ...
 Related Topics 哈希表 链表 双指针 👍 1985 👎 0
...
public class LinkedListCycleIiMain {
    ...
    public static void main(String[] args) {
        Solution solution = new LinkedListCycleIiMain().new Solution();
        solution.detectCycle(Utils.parseToListNodeWithCircleFromString("[3,2,0,-4]", 1));
    }
