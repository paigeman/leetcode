...
给你无向 连通 图中一个节点的引用，请你返回该图的 深拷贝（克隆）。 
 ...
 简单起见，每个节点的值都和它的索引相同。例如，第一个节点值为 1（val = 1），第二个节点值为 2（val = 2），以此类推。该图在测试用例中使用邻接列
表表示。 
...
输出：[[2],[1]] 
 ...
 Related Topics 深度优先搜索 广度优先搜索 图 哈希表 👍 583 👎 0
...
public class CloneGraphMain {
    ...
    public static void main(String[] args) {
        Solution solution = new CloneGraphMain().new Solution();
