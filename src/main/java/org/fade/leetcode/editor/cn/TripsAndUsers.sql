...
2013-10-03：
 ...
 Related Topics 数据库 👍 362 👎 0

*/
  
#leetcode submit region begin(Prohibit modification and deletion)
# Write your MySQL query statement below
select v1.Day, round(ifnull(v1.nums, 0) / v2.nums, 2) as `Cancellation Rate`
from
(select t.request_at as `Day`, count(*) as nums
from Trips t
left join Users u
on t.client_id = u.users_id
where t.request_at between '2013-10-01' and '2013-10-03' and u.banned = 'No' and status != 'completed'
group by t.request_at) v1
left join
(select t.request_at as `Day`, count(*) as nums
from Trips t
left join Users u
