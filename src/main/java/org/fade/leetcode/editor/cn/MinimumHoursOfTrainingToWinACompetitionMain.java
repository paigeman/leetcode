...
public class MinimumHoursOfTrainingToWinACompetitionMain {
      
    public static void main(String[] args) {
        Solution solution = new MinimumHoursOfTrainingToWinACompetitionMain().new Solution();
        solution.minNumberOfHours(5, 3, Utils.parseToArrayFromString("[1,4,3,2]"), Utils.parseToArrayFromString("[2,6,3,1]"));
    }
